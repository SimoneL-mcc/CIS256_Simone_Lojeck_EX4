...
# Exercise 4.0 (EX4) - Game to guess a word

import random

def select_word(words):
    """ Function: Randomly select a word from inputted list of words """
    # select random word
    word = random.choice(words)
    # Expansion: random choice of topic, and then word from topic's list
    return word

def process_guess(word, index, guess, num_guesses):
    """ Function: Process the current guess """
    endgame = False
